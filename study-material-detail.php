...
if (!$material) {
    if (isset($_GET['slug']) && $_GET['slug'] === 'hc-verma-concepts-solutions') {
        $material = [
            'id' => 0,
    ...
    } elseif (isset($_GET['slug']) && $_GET['slug'] === 'ncert-complete-solutions-roadmap') {
        $material = [
            'id' => 0,
...
$file_exists_on_disk = !empty($material['file_path']) && file_exists(__DIR__ . '/uploads/materials/' . $material['file_path']);
            ...
            <div class="col-lg-4">
                <div class="sticky-top" style="top: 140px; z-index: 5;">
                    ...
                    <div class="request-vault-card p-4 p-md-5 rounded-5 bg-white shadow-2xl border border-light text-center position-relative overflow-hidden">
                        ...
                        <!-- Quick Preview Portal -->
                        <div class="preview-portal-card p-4 rounded-5 mb-4 text-center border border-primary border-opacity-25 shadow-lg" style="background: linear-gradient(145deg, #ffffff, #fff9f2);">
                            <div class="d-flex align-items-center justify-content-center gap-3 mb-3">
                                <div class="pulse-indicator"></div>
                                <span class="fw-bold text-primary small tracking-widest text-uppercase">Direct Access Available</span>
                            </div>
                            <h4 class="fw-black mb-3 text-dark">READY TO <span class="text-primary">LEARN?</span></h4>
                            <a href="<?php echo BASE_URL; ?>document-viewer.php?file=<?php echo urlencode($material['file_path']); ?>&title=<?php echo urlencode($material['title']); ?>" class="btn btn-preview-wow w-100 py-3 rounded-pill fw-black text-uppercase shadow-sm">
                                <i class="fas fa-eye me-2"></i> OPEN MODULE PREVIEW
                            </a>
                            <p class="very-small text-muted mt-3 mb-0">Experience our pedagogical depth before full registration.</p>
                        </div>
