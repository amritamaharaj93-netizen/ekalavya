...
<section class="page-header" style="background: linear-gradient(rgba(0,0,0,0.85), rgba(0,0,0,0.7)), url('assets/images/test-series-hero.png') center/cover no-repeat; padding: clamp(40px, 8vh, 100px) 0 !important;">
