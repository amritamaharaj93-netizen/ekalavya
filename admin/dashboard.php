        ...
        <div class="col admin-main">
            ...
            <div class="row g-4 mb-5">
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="stat-card">
                        <div class="label text-primary">Request Access</div>
            ...
            <div class="mt-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h5 class="fw-bold m-0"><i class="fas fa-history me-2 text-primary"></i> Recent Access Requests</h5>
                    <a href="view-enquiries.php" class="btn btn-sm btn-outline-primary rounded-pill px-3">View All Requests</a>
                </div>
