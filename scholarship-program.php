...
<section class="page-header" style="background: linear-gradient(rgba(0,0,0,0.85), rgba(0,0,0,0.7)), url('<?php echo BASE_URL; ?>assets/images/scholarship_hero.png') center/cover no-repeat; padding: 30px 0 !important;">
    <div class="container text-center text-white">
        <div class="text-primary fw-bold tracking-widest mb-2 animate-up" style="font-size: 0.75rem; text-transform: uppercase;">Recognising Talent. Rewarding Merit.</div>
        <h1 class="h3 fw-black mb-2 text-uppercase">EKALAVYA SCHOLARSHIP <span class="text-primary">Program - 2026</span></h1>
        <p class="text-white mb-0 opacity-90 small">🎓 Win up to 100% Scholarship on courses for NEET, JEE & Classes 7-10.</p>
    </div>
</section>
