...
if ($course) {
    ...
    if (empty($course['fees'])) {
        ...
        if (strpos($title_upper, 'EMERGE') !== false || strpos($title_upper, 'XII') !== false || strpos($title_upper, '12TH') !== false)
            $study_material_text = "Class-12th study material";
        elseif (strpos($title_upper, 'NURTURE') !== false || strpos($title_upper, 'XI') !== false || strpos($title_upper, '11TH') !== false)
            $study_material_text = "Class-11th study material";
        elseif (strpos($title_upper, '7TH') !== false)
            $study_material_text = "Class-7th study material";
        elseif (strpos($title_upper, '8TH') !== false)
            $study_material_text = "Class-8th study material";
        elseif (strpos($title_upper, '10TH') !== false)
            $study_material_text = "Class-10th study material";
        elseif (strpos($title_upper, 'IMPULSE') !== false || strpos($title_upper, 'DROPPER') !== false)
            $study_material_text = "Dropper study material";
        elseif (strpos($title_upper, 'SEED') !== false || strpos($title_upper, 'IX') !== false || strpos($title_upper, '9TH') !== false)
            $study_material_text = "Class-9th study material";
    }
            ...
            <div class="col-lg-8">
                <nav aria-label="breadcrumb" class="mb-5">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo BASE_URL; ?>courses"
                                class="text-secondary text-decoration-none">Classroom Courses</a></li>
                ...
                <div class="d-flex flex-wrap align-items-center gap-2 mb-4">
                    <span class="badge bg-dark px-3 py-2 rounded-1 fw-bold text-uppercase"
                        style="font-size: 0.6rem; letter-spacing: 1px;">Regular Course</span>
                    <span class="badge bg-primary px-3 py-2 rounded-1 fw-bold text-uppercase"
                        style="font-size: 0.6rem; letter-spacing: 1px;">Classroom Program</span>
                </div>
                ...
                <p class="lead text-muted mb-5 pe-lg-5" style="line-height: 1.6;">
                ...
                <?php if ($course['admission_eligibility']): ?>
                    <div class="modern-hub-header mb-5">
                        <div
                            class="eligibility-ribbon d-inline-flex align-items-center gap-3 p-2 pe-4 rounded-pill bg-white shadow-sm border border-primary border-opacity-25 mb-4">
                            <div class="pulse-icon bg-primary rounded-circle d-flex align-items-center justify-content-center"
                ...
                <div class="course-info-hub p-4 p-md-5 rounded-5 border border-white mb-5 position-relative overflow-hidden shadow-2xl"
                    style="background: rgba(255, 255, 255, 0.7); backdrop-filter: blur(20px);">
                    <div class="row g-5 align-items-center">
                        <div class="col-md-4">
                            <div class="hub-item d-flex align-items-center gap-4">
                                <div class="hub-orb"
                                    style="background: linear-gradient(45deg, #1a73e8, #64b5f6); box-shadow: 0 10px 20px rgba(26, 115, 232, 0.3);">
                                    <i class="fas fa-clock text-white fs-4"></i>
                                </div>
                                <div>
                                    <small class="text-uppercase fw-black text-muted d-block mb-1"
                                        style="font-size: 0.65rem; letter-spacing: 1.5px;">Duration</small>
                        ...
                        <div class="col-md-4">
                            <div class="hub-item d-flex align-items-center gap-4 border-start border-light ps-md-4">
                                <div class="hub-orb"
                                    style="background: linear-gradient(45deg, #34a853, #81c784); box-shadow: 0 10px 20px rgba(52, 168, 83, 0.3);">
                                    <i class="fas fa-graduation-cap text-white fs-4"></i>
                                </div>
                                <div>
                                    <small class="text-uppercase fw-black text-muted d-block mb-1"
                                        style="font-size: 0.65rem; letter-spacing: 1.5px;">Stream</small>
                                    <h5 class="fw-black text-dark mb-0">
                        ...
                        <div class="col-md-4">
                            <div class="hub-item d-flex align-items-center gap-4 border-start border-light ps-md-4">
                                <div class="hub-orb"
                                    style="background: linear-gradient(45deg, #fbbc04, #ffd54f); box-shadow: 0 10px 20px rgba(251, 188, 4, 0.3);">
                                    <i class="fas fa-globe text-white fs-4"></i>
                                </div>
                                <div>
                                    <small class="text-uppercase fw-black text-muted d-block mb-1"
                                        style="font-size: 0.65rem; letter-spacing: 1.5px;">Medium</small>
                                    <h5 class="fw-black text-dark mb-0">
                                        <?php echo htmlspecialchars($course['medium'] ?: 'English / Hindi'); ?>
                                    </h5>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="position-absolute bg-primary bg-opacity-5 rounded-circle"
                        style="width: 200px; height: 200px; top: -100px; right: -50px; filter: blur(50px);"></div>
                </div>
            </div>

            <!-- Side Sticky Card (Floating Position) - Thinner Profile -->
            <div class="col-lg-4">
                <div class="enrollment-preferences-box compact-form-container sticky-top shadow-2xl bg-white border border-light p-4 px-xl-4 py-xl-5"
                    style="top: 140px; z-index: 20; border-radius: 25px; max-width: 380px; margin-left: auto;">
                    <h4 class="fw-black mb-5 text-dark text-uppercase"
                        style="font-size: 1.3rem; letter-spacing: 0.5px;">Enrollment Details</h4>

                    <div class="mb-5">
                        <label
                            class="form-label very-small fw-black text-muted text-uppercase tracking-wider mb-3">Academic
                            Session</label>
                        <div class="d-flex gap-2">
                            <div class="w-100 p-3 rounded-3 bg-light border text-center fw-bold text-dark">
                                <?php echo htmlspecialchars($course['academic_session'] ?: '2026-2027'); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-5">
                        <label
                            class="form-label very-small fw-black text-muted text-uppercase tracking-wider mb-3">Select
                            Study Center</label>
                        <select class="form-select border-0 bg-light p-3 rounded-3 fw-bold shadow-none">
                            <?php
                            $stmt_centers = $pdo->query("SELECT name FROM study_centers ORDER BY is_head_office DESC, created_at ASC");
                            $centers_list = $stmt_centers->fetchAll(PDO::FETCH_COLUMN);

                            if ($centers_list) {
                                foreach ($centers_list as $center_name) {
                                    echo '<option>' . htmlspecialchars($center_name) . '</option>';
                                }
                            }

                            // Check if Online Live Platform is already in the list, if not add it
                            if (!in_array("Online Live Platform", $centers_list)) {
                                echo '<option>Online Live Platform</option>';
                            }
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="mb-5">
                        <label class="form-label very-small fw-black text-muted text-uppercase tracking-wider mb-3">Fee
                            Summary</label>
                        <div class="p-4 rounded-4 bg-primary bg-opacity-10 border border-primary border-opacity-10">
                            ...
                            <div class="fee-includes-list mt-3 mb-3 pt-3 border-top border-primary border-opacity-10">
                                <h6 class="very-small fw-black text-dark text-uppercase mb-2"
                                    style="font-size: 0.6rem; letter-spacing: 0.5px;">Things Included in fee</h6>
                                <ul class="list-unstyled mb-0">
                                    ...
                                    if (!empty($course['fee_includes'])) {
                                        ...
                                        // Fallback if empty
                                        ?>
                                        <li class="very-small text-muted d-flex align-items-start gap-2 mb-1"
                            ...
                            <div class="d-flex justify-content-between align-items-baseline">
                                <span class="fw-bold text-dark small"><i
                                        class="fas fa-graduation-cap me-1 text-primary"></i> Avail scholarship
                                    <?php echo $scholarship_text; ?></span>
                                <span
                                    class="fw-black text-primary fs-3">₹<?php echo number_format($discounted_fee, 0); ?></span>
                            </div>
                        </div>
                    </div>

                    <button class="btn btn-primary w-100 py-3 rounded-3 fw-black shadow-lg mb-4" data-bs-toggle="modal"
                        data-bs-target="#enquiryModal" data-course="<?php echo htmlspecialchars($course['title']); ?>"
                        style="font-size: 1.1rem; height: 60px; display: flex; align-items: center; justify-content: center;">REQUEST
                        ACCESS <i class="fas fa-arrow-right-long ms-2"></i></button>
                    <p class="text-center small text-muted mb-0">Admission via <a
                            href="<?php echo BASE_URL; ?>scholarship"
                            class="text-primary fw-bold text-decoration-none border-bottom border-primary border-2 pb-1">ESAT
                            Scholarship Test</a></p>
                </div>
            </div>
        </div>
    </div>
...
<section class="what-you-get py-6 bg-white">
    <div class="container">
        <div class="section-title text-center mb-5">
            ...
            <p class="text-muted max-width-700 mx-auto">Our classroom programs are designed to provide a 360-degree
                learning experience that goes beyond lectures.</p>
        </div>

        <div class="experience-stack vstack gap-0">
            <?php foreach ($experience as $index => $item): ?>
                <div
                    class="exp-item d-flex align-items-center justify-content-between p-4 p-md-5 rounded-4 border-bottom hover-bg-light transition-all">
                    <div class="exp-content pe-lg-5">
                        <h4 class="fw-bold mb-3"><i
                                class="<?php echo $item['icon'] ?: 'fas fa-check'; ?> text-primary me-2 opacity-50"></i>
                            <?php echo htmlspecialchars($item['title']); ?></h4>
                    ...
                    <div
                        class="exp-icon bg-<?php echo ($index % 2 == 0) ? 'orange' : 'blue'; ?>-soft p-4 rounded-circle d-none d-md-block">
        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-5">
                <div class="sticky-top" style="top: 140px;">
                    ...
                    <h2 class="fw-black h1 mb-4">How You Will <br>Master Your <span class="text-primary">Goals</span>
                    </h2>
                    <p class="text-muted mb-5">At Ekalavya, we follow a scientifically structured student journey that
                        ensures consistent growth from day one to the final examination.</p>
                    <div class="row g-3">
                        <div class="col-6">
...
<section class="curriculum-detail py-6 bg-white">
    <div class="container">
        <div class="section-title text-center mb-6">
            <h2 class="fw-black mb-3" style="font-size: clamp(1.4rem, 5vw, 3rem); letter-spacing: -1px;">Detailed <span
                    class="text-primary">Curriculum</span></h2>
                ...
                <div class="learning-path-timeline position-relative">
                    ...
                    foreach ($curriculum as $index => $module):
                        ...
                        <div class="learning-module-card mb-5 position-relative">
                            <div class="module-number-pill position-absolute d-none d-xl-flex">
                                <?php echo str_pad($index + 1, 2, '0', STR_PAD_LEFT); ?>
                            </div>
                            <div class="card border-0 shadow-2xl rounded-5 overflow-hidden transition-all hover-lift">
                                <div
                                    class="card-header bg-<?php echo $color; ?> p-4 border-0 d-flex justify-content-between align-items-center">
                                    <h4 class="text-white fw-black mb-0"><?php echo htmlspecialchars($module['title']); ?>
                                    </h4>
                                    <span class="badge bg-white rounded-pill px-3 py-2 fw-bold text-<?php echo $color; ?>"
                                        style="font-size: 0.7rem;"><?php echo htmlspecialchars($module['badge'] ?: 'ACADEMIC'); ?></span>
                                </div>
                                <div class="card-body p-4 p-md-5">
                                    <div class="row align-items-center">
                                        <div class="col-md-7">
                                            <p class="lead text-dark fw-bold mb-4">
                                                <?php echo htmlspecialchars($module['desc']); ?>
                                            </p>
                                            <div class="row g-3">
                                                <?php
                                                ...
                                                foreach ($topics as $topic): ?>
                                                    <div class="col-sm-6">
                                                        <div class="d-flex align-items-center gap-2 mb-2">
                                                            ...
                                                            <span
                                                                class="small fw-bold text-muted"><?php echo trim(htmlspecialchars($topic)); ?></span>
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
                                        ...
                                        <div class="col-md-5 text-center text-md-end mt-4 mt-md-0">
                                            <div
                                                class="outcome-box d-inline-block p-4 rounded-4 bg-light border border-white">
                                                <i
                                                    class="<?php echo $module['outcome_icon'] ?: 'fas fa-bullseye'; ?> text-<?php echo $color; ?> fs-3 mb-2"></i>
                                                <small class="d-block text-dark opacity-50 text-uppercase fw-black"
                                                    style="font-size: 0.6rem;">Key Outcome</small>
                                                <span
                                                    class="fw-black text-dark"><?php echo htmlspecialchars($module['outcome_text'] ?: 'Success'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<section class="fee-structure py-6 bg-light">
    <div class="container">
        ...
        <div class="fee-structure-v2 shadow-2xl bg-white rounded-5 border border-light overflow-hidden">
                    ...
                    <tbody>
                        <tr>
                            <td class="ps-5 py-5">
                                ...
                                <small class="text-muted d-block mt-1">Includes Concept Modules, Practice Sheets (CPPs),
                                    and full access to the Assessment Vault.</small>
                            </td>
                            <td class="text-center py-5 bg-primary bg-opacity-10">
                                <h2 class="fw-black text-primary mb-0">₹<?php echo number_format($course['fees'], 0); ?>
                                </h2>
                                <span class="badge bg-success px-2 py-1 rounded-pill very-small uppercase mt-2"><i
                                        class="fas fa-graduation-cap me-1"></i> Avail scholarship
                                    <?php echo $scholarship_text; ?></span>
                            </td>
                            <td class="py-5 pe-5">
            ...
            <div
                class="bg-dark p-4 px-md-5 d-flex flex-column flex-md-row justify-content-between align-items-center text-white text-center text-md-start gap-4">
                <div class="d-flex align-items-center gap-3">
                    <i class="fas fa-graduation-cap fs-4 text-primary"></i>
                    <div>
                        <h6 class="mb-0 fw-bold text-white">ESAT Scholarship Potential</h6>
                        <p class="very-small text-white-50 mb-0">Save up to 100% based on scholarship test performance.
                        </p>
                    </div>
                </div>
                <a href="<?php echo BASE_URL; ?>scholarship"
                    class="btn btn-outline-primary rounded-pill px-5 py-2 fw-bold text-nowrap">Register for ESAT</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-4">
                ...
                <p class="text-muted mb-0">Our refund policy is designed to be fair and transparent, linked directly to
                    the academic commencement date of each batch.Not applicable for payments made in more than two
                    installments</p>
            </div>
            <div class="col-lg-8">
                <div class="row g-3">
                    <div class="col-sm-6 col-xl-3">
                        <div class="refund-box-premium p-4 rounded-4 border border-light shadow-sm text-center transition-all h-100"
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="refund-box-premium p-4 rounded-4 border border-light shadow-sm text-center transition-all h-100"
                            ...
                            <span
                                class="very-small fw-black text-primary text-uppercase tracking-widest mb-2 d-block">Phase
                                2</span>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="refund-box-premium p-4 rounded-4 border border-light shadow-sm text-center transition-all h-100"
                            ...
                            <span
                                class="very-small fw-black text-warning text-uppercase tracking-widest mb-2 d-block">Phase
                                3</span>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="refund-box-premium p-4 rounded-4 border border-light shadow-sm text-center transition-all h-100"
                            ...
                            <span
                                class="very-small fw-black text-danger text-uppercase tracking-widest mb-2 d-block">Phase
                                4</span>
