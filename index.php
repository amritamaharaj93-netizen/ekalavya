                    ...
                    <div class="col-lg-4 col-md-12 bg-white p-4 p-lg-5 d-flex align-items-center">
                        <div class="booking-form-wrap w-100">
                            ...
                            <form action="<?php echo BASE_URL; ?>process-contact.php" method="POST" class="vstack gap-2">
                                ...
                                <div class="form-group">
                                    <input type="tel" name="phone" class="form-control-minimal p-2 px-3 rounded-2 w-100 border bg-light shadow-sm small" placeholder="Mobile Number" maxlength="10" pattern="[0-9]{10}" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required>
                                </div>
