                    ...
                    <div class="registration-form-card p-4 p-md-5 position-relative overflow-hidden bg-white">
                        ...
                        <form action="<?php echo BASE_URL; ?>process-scholarship.php" method="POST" class="vstack gap-3 position-relative">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <div class="form-floating">
                                        <input type="tel" name="phone" class="form-control rounded-4 border-0 bg-light px-4" id="popRegPhone" placeholder="Mobile" style="height: 58px;" maxlength="10" pattern="[0-9]{10}" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required>
                        ...
                        <form id="globalEnquiryForm" action="<?php echo BASE_URL; ?>process-enquiry.php" method="POST">
                            <div class="row g-2 mb-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="tel" class="form-control-minimal rounded-2 w-100 border text-dark py-1 px-3" name="phone" placeholder="Mobile" style="font-size: 0.8rem; height: 38px;" maxlength="10" pattern="[0-9]{10}" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required>
                                </div>
                                <div class="col-md-6">
                            ...
                            <button type="submit" class="btn btn-primary w-100 py-2 rounded-pill fw-black shadow-lg mb-3" style="font-size: 0.8rem;">REQUEST ACCESS <i class="fas fa-arrow-right ms-2"></i></button>
