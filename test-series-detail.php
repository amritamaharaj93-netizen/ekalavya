                ...
                <div class="sticky-top" style="top: 140px; z-index: 5;">
                    <div class="course-summary-card p-4 rounded-4 bg-white border border-light shadow-2xl" style="max-width: 400px; margin-left: auto;">
                        ...
                        <div class="cta-stack vstack gap-2">
                            <button class="btn btn-primary w-100 py-2 rounded-2 fw-black shadow-lg small" data-bs-toggle="modal" data-bs-target="#enquiryModal" data-course="Test Series: <?php echo htmlspecialchars($test['title']); ?>">REQUEST ACCESS <i class="fas fa-paper-plane ms-2"></i></button>
